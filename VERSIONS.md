...
| GitHub CLI | v2.93.0 | ME_GitHub_CLI.msi | 14 MB |
| Terraform | 1.15.5 | ME_Terraform.zip | 33.7 MB |
| nvm-windows | 1.2.2 | ME_nvm_windows.zip | 6 MB |
| PowerShell 7 | v7.6.2 | ME_PowerShell_7.msi | 109.6 MB |
| Node.js LTS | v24.16.0 | ME_Node_LTS.zip | 34.8 MB |
